...
# Activate theme.
npm run wp-env run cli "wp theme activate storefront --quiet"

# Activate plugins.
npm run wp-env run cli "wp plugin activate woocommerce --quiet"
npm run wp-env run cli "wp plugin activate woocommerce-gateway-dummy --quiet"
